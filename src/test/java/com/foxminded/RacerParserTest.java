...
public class RacerParserTest {
    ...
    void givenLists_whenGetRacers_thenListOfRacers() {
        ...
        List<Racer> actualResult = racerParser.inputRacesList(startFile, endFile, abbreviations);
